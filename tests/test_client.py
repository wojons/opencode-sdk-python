...
class TestOpencode:
    ...
    def test_client_timeout_option(self) -> None:
        client = Opencode(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_base_url_setter(self) -> None:
        client = Opencode(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Opencode(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            Opencode(
    ...
    def test_base_url_trailing_slash(self, client: Opencode) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Opencode) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Opencode) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Opencode(base_url=base_url, _strict_response_validation=True)
...
class TestAsyncOpencode:
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncOpencode(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    @pytest.mark.parametrize(
        "client",
        [
            AsyncOpencode(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            AsyncOpencode(
                base_url="http://localhost:5000/custom/path/",
                _strict_response_validation=True,
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncOpencode(base_url=base_url, _strict_response_validation=True)
